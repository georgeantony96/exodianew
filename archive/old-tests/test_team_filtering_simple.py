...
def test_team_filtering():
    ...
    try:
        ...
        # Test 3: Count total Barcelona instances (should be exactly 1)
        print("\nTest 3: Total Barcelona instances")
        ...
        # Test 4: Verify Barcelona is only in La Liga
        print("\nTest 4: Verify Barcelona league assignment")
        cursor.execute("""
        ...
        if all_passed:
            print("[SUCCESS] ALL TESTS PASSED - Barcelona filtering is working correctly!")
